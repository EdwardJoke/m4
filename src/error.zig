...
pub const ERROR_DB = [_]ErrorInfo{
    ...
    .{ .code = "r005", .title = "Type Mismatch in Comparison", .description = "A comparison operator (>, <, >=, <=) was applied to incompatible types." },
    ...
    .{ .code = "r008", .title = "Index Out of Bounds", .description = "A vector/array index was outside the valid range [0, length)." },
    .{ .code = "r009", .title = "Not Indexable", .description = "An index operation was applied to a value that is not a vector or indexable collection." },
